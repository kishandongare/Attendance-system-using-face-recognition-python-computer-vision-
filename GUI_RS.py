...
def take_img():
    try:
        ...
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'C:/project/attsys/Datasets/' + Enrollment + ' ' + Name
        new_path = 'C:/project/attsys/Datasets/' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0
...
message = tk.Label(window, text="FACE RECOGNITION BASED-ATTENDANCE SYSTEM", bg="SpringGreen3", fg="white", width=50,
