...
window = tk.Tk()
window.title("FAMS-Face Recognition Based Attendance System")
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\project\attsys\Attendance\-------Check atttendance-------"')
...
message = tk.Label(window, text="FACE RECOGNITION BASED- ATTENDANCE SYSTEM", bg="cyan", fg="blue", width=50,
